        ...
        >
          <div className="relative w-full aspect-[16/9] rounded-2xl overflow-hidden border border-[var(--card-border)] shadow-2xl">
            <Image
              ...
              alt="CRM voor salons — het complete klantenbestand op de receptiebalie"
              fill
              priority
        ...
        >
          <div className="relative w-full aspect-[16/9] rounded-2xl overflow-hidden border border-[var(--card-border)] shadow-xl">
            <Image
              ...
              alt="Saloneigenaar werkt het klantprofiel bij op een tablet"
              fill
              className="object-cover"
              sizes="(max-width: 1024px) 100vw, 1024px"
            />
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center mb-12">
            ...
            >
              <Image
                ...
                alt="Klantprofiel met volledige behandelhistorie op een tablet in de salon"
                fill
                className="object-cover"
            ...
            <motion.div
              ...
              transition={{ duration: 0.6 }}
            >
              <h2 className="text-2xl md:text-3xl font-bold mb-4">Eén klantbeeld voor je hele salon</h2>
              <p className="text-foreground-accent leading-relaxed">Elke chatbot-conversatie, elk Voice AI-gesprek en elke automatische herinnering landt in de CRM — gekoppeld aan het juiste klantprofiel. Je ziet in 5 seconden wie de klant is en wat er speelt.</p>
            </motion.div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <Link href="/automatisering" className="group border border-[var(--card-border)] rounded-2xl p-6 bg-[var(--card-background)] hover:border-primary/40 transition-all">
                ...
                <p className="text-foreground-accent text-sm mb-3">Herinneringen, opvolging en winback automatisch versturen vanuit de CRM.</p>
