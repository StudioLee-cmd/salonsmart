...
const STATIC_LASTMOD_FALLBACK = '2026-08-04'
...
export default function sitemap(): MetadataRoute.Sitemap {
    const baseUrl = 'https://www.salonsmart.nl'
    ...
    const staticPages = [
        ...
        '/crm', '/free-trial', '/automatisering', '/privacy', '/legal', '/algemene-voorwaarden',
    ]
