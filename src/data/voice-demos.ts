...
export const voiceDemos: VoiceDemoOpname[] = [
    {
        ...
        richting: 'Een nieuwe klant belt voor een wimperbehandeling; de agent vraagt door op de gewenste look en plant de juiste behandeltijd.',
        stem: 'Thomas',
        src: null,
        duur: null,
    },
    {
        ...
        richting: 'Een klant wil haar nagelafspraak van zaterdag verzetten naar een doordeweekse avond.',
        stem: 'Sanne',
        src: null,
        duur: null,
    },
    {
        ...
        richting: 'Iemand vraagt ’s avonds wat een set gellak kost en hoe lang het houdt.',
        stem: 'Eva',
        src: null,
        duur: null,
    },
