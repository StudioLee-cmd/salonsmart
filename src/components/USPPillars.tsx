...
const pillars = [
    {
        ...
        pillarLinks: [{ href: "/voice-ai", anchor: "ai telefonist voor salons" }, { href: "/chatbot", anchor: "ai chatbot voor salons" }],
    },
    {
        ...
        icon: <FiStar size={32} />,
        pillarLinks: [{ href: "/seo", anchor: "seo voor salons" }, { href: "/reviews", anchor: "review management voor salons" }],
    },
    {
        ...
        pillarLinks: [{ href: "/automatisering", anchor: "workflow automatisering voor salons" }, { href: "/crm", anchor: "crm voor salons" }],
    },
    {
        ...
        pillarLinks: [{ href: "/gratis-website", anchor: "gratis website voor salons" }],
    }
];
