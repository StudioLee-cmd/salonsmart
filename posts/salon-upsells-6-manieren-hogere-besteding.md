...
- Digitale bonnen via een [gekoppelde betaal-link](/chatbot) die instant verkocht worden.
...
1. **Vandaag**: kies 1 methode (bijv. Methode 1 - tijdens-upsell) en oefen 1 voorbeeld.
2. **Deze week**: alle medewerkers doen rollenspel met die ene methode.
3. **Deze maand**: meet wekelijks hoeveel upsell-kansen genomen worden.
4. **Na 3 maanden**: voeg een 2e methode toe (bijv. product-upsell).
5. **Na 6 maanden**: meet bestedingsgroei + klanttevredenheid.

Wil je weten waar jouw salon qua upsell-mogelijkheden nu staat? Vraag een [gratis AI-scan aan](/gratis-scan), we analyseren je huidige klant-journey en geven concrete aanbevelingen per salon-type. Een [moderne boekingstool](/gratis-website) kan daarbovenop automatisch pakket-suggesties tonen tijdens het online boeken, wat een vroeg contactpunt is voor de eerste upsell.
